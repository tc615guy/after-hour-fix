          ...
          <CardContent className="px-2 py-2">
            ...
            {view === 'calendar' && selectedProject ? (
              ...
              <>
                ...
                {bookings.filter(b => !b.technicianId && b.status !== 'canceled' && b.status !== 'failed').length > 0 && (
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 flex-1">
                        <p className="text-sm font-medium text-yellow-800">
                          {bookings.filter(b => !b.technicianId && b.status !== 'canceled' && b.status !== 'failed').length} booking(s) need technician assignment
                        </p>
                        <p className="mt-1 text-sm text-yellow-700">
                          These bookings were created but no technician was available. Please assign them manually or they won't appear on the daily schedule.
                        </p>
                      </div>
                    </div>
                  </div>
