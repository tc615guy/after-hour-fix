...
CREATE TABLE "Project" (
    ...
    "pricingSheet" JSONB,
    "emergencyMultiplier" DOUBLE PRECISION NOT NULL DEFAULT 1.5,
    "calcomApiKey" TEXT,
    "calcomUser" TEXT,
    "calcomUserId" INTEGER,
    "calcomAccessToken" TEXT,
    "calcomRefreshToken" TEXT,
    "calcomTokenExpiry" TIMESTAMP(3),
    "calcomEventTypeId" INTEGER,
    "calcomConnectedAt" TIMESTAMP(3),
    ...
    "allowWeekendBooking" BOOLEAN NOT NULL DEFAULT true,
    "requireOnCallForWeekend" BOOLEAN NOT NULL DEFAULT false,
    "allowOverage" BOOLEAN NOT NULL DEFAULT false,
    "membershipActive" BOOLEAN NOT NULL DEFAULT true,
    "notificationsEmail" TEXT,
    "minutesAlert80Sent" BOOLEAN NOT NULL DEFAULT false,
    "minutesAlert100Sent" BOOLEAN NOT NULL DEFAULT false,
    "adminNotes" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Booking" (
    ...
    "costSheetSent" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deletedAt" TIMESTAMP(3),
